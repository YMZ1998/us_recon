...
bool us_recon_core_export ApplyGrayFilter(const std::vector<unsigned char>& header,
                                          std::vector<unsigned char>& rgbData);

bool us_recon_core_export FlipVertically(const std::vector<unsigned char>& header,
                                         std::vector<unsigned char>& rgbData);
